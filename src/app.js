...
class App{
    ...
    initPages() {
        ...
        groups.CHR = getBtnGroups("社交力", 0, 10); // 社交力 charm CHR
        groups.INT = getBtnGroups("情感值", 0, 10); // 情感值 intelligence INT
        groups.STR = getBtnGroups("因果量", 0, 10); // 因果量 strength STR
        ...
        trajectoryPage
            ...
            .click(()=>{
                ...
                if(isEnd) {
                    ...
                    $("#lifeProperty").html(`
                    <li>社交力：${property.CHR} </li> 
                    <li>情感值：${property.INT} </li> 
                    <li>因果量：${property.STR} </li> 
        ...
        <div id="main">
            ...
            <ul id="judge" class="judge" style="bottom: calc(35% + 2.5rem)">
                <li class="grade2"><span>社交力：</span>9级 美若天仙</li>
                <li><span>情感值：</span>4级 情感值一般</li>
                <li><span>因果量：</span>1级 极度虚弱</li>
                ...
                clear: ()=>{
                    ...
                    judge.append([
                        (()=>{
                            ...
                            return `<li class="grade${grade}"><span>社交力：</span>${value} ${judge}</li>`
                        })(),
                        (()=>{
                            const { judge, grade, value } = s('INT', max);
                            return `<li class="grade${grade}"><span>情感值：</span>${value} ${judge}</li>`
                        })(),
                        (()=>{
                            const { judge, grade, value } = s('STR', max);
                            return `<li class="grade${grade}"><span>因果量：</span>${value} ${judge}</li>`
                        })(),
                        (()=>{
